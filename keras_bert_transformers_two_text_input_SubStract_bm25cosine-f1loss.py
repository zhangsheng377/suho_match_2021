...
check_point_path = 'trained_model_substract_f1loss/multi_keras_bert_sohu.weights'
weights_path = "trained_model_substract_f1loss/multi_keras_bert_sohu_final.weights"
result_path = "trained_model_substract_f1loss/multi_keras_bert_sohu_test_result_final.csv"
...
#         print(data_list)
        ...
        for data in data_list:
            input_ids_texta, token_type_ids_texta, attention_mask_texta,             input_ids_textb, token_type_ids_textb, attention_mask_textb,             bm25, tf_cosine, tfidf_cosine,             cat_texta, cat_textb,             labelA, labelB = data
...
def get_test_iterator(data_path, file_name):
  ...
  for input_ids_texta, token_type_ids_texta, attention_mask_texta,       input_ids_textb, token_type_ids_textb, attention_mask_textb,       bm25, tf_cosine, tfidf_cosine,       cat_source, cat_target,       id in it:
